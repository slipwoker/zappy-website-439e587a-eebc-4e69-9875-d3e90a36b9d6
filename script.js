document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (!input) return;
            if (input.closest('.form-group')?.querySelector('.form-error') || input.style.borderColor === 'rgb(220, 53, 69)') {
                validateField(input);
            }
        });
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (submitButton) {
                ...
                submitButton.textContent = isRTL ? 'جاري الإرسال...' : 'Sending...';
            }
            ...
            fetch(formAction, fetchOptions)
                ...
                .catch(function() {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; border: 1px solid #dc3545; border-radius: 4px; text-align: center;';
                    errorMessage.textContent = isRTL ? 'حدث خطأ. يرجى المحاولة مرة أخرى.' : 'An error occurred. Please try again.';
                    
                    const existingGlobalError = contactForm.querySelector('.form-error-global');
    ...
    if (animatedElements.length > 0) {
        ...
        function handleScrollAnimations() {
            animatedElements.forEach(function(el) {
                if (isElementInViewport(el, 80)) {
                    el.classList.add('visible', 'fade-in-visible');
                    el.style.opacity = '1';
        ...
        animatedElements.forEach(function(el) {
            ...
            el.style.transition = 'opacity 0.6s ease-out, transform 0.6s ease-out, visibility 0.6s ease-out';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '439e587a-eebc-4e69-9875-d3e90a36b9d6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '439e587a-eebc-4e69-9875-d3e90a36b9d6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '439e587a-eebc-4e69-9875-d3e90a36b9d6';
